...
namespace _Project.Scripts.Runtime
{
    ...
    public class Cardboarder : MonoBehaviour
    {
        ...
        //to let the shader know to reverse the normals for the backside
        private const string BacksideShaderKeywordName = "_BACKSIDE";
        private LocalKeyword _backsideShaderKeyword;

        private void Awake()
        {
            if (DoubleSided)
                _backsideShaderKeyword = new LocalKeyword(CardboardFaceMaterial.shader, BacksideShaderKeywordName);
        }
        ...
        void Start()
        {
            ...
            if (DuplicateSpriteOnBackFace)
            {
                ...
                if (originalSpriteRenderer != null)
                {
                    ...
                    spriteRenderer.material.EnableKeyword(_backsideShaderKeyword);
                }
            }
        }
